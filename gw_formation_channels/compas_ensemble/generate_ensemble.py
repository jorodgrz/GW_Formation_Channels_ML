...
class COMPASEnsembleGenerator:
    ...
    def __init__(
        self,
        compas_binary: str,
        output_base: str = "./compas_ensemble_output",
        ...
        """
        self.compas_binary = compas_binary
...
def main():
    ...
    parser.add_argument(
        '--compas-binary',
        default='/Users/josephrodriguez/ASTROTHESIS/COMPAS/src/bin/COMPAS',
        help='Path to COMPAS executable'
    )
    parser.add_argument(
        '--output-dir',
        default='./compas_ensemble_output',
